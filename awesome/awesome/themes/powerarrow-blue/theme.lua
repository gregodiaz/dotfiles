...
theme.bg_focus                                  = "#7197E7" --FF79C6 window focus
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "Ubuntu 11", fg = theme.fg_normal },
...
theme.fs = lain.widget.fs({
    notification_preset = { fg = theme.fg_normal, bg = theme.bg_normal, font = "Ubuntu Medium 10" },
    settings = function()
