...
theme.font                                      = "FiraCode NFM 11"
theme.taglist_font                              = "FiraCode NFM 13"
...
--     notification_preset = { font = "FiraCode NFM 10", fg = theme.fg_normal },
...
local cpu = lain.widget.cpu({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#7493d2", cpu_now.usage .. "% "))
    end
})
