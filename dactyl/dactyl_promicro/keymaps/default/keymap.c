...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x6(
        ...
        KC_LSFT, KC_A  ,KC_S   , KC_D  , KC_F  , KC_G  ,        KC_H   , KC_J  , KC_K  ,  KC_L   ,LT2_COL,  LG_QUOT,
        KC_LCTL, CTL_Z ,KC_X   , KC_C  , KC_V  , KC_B  ,        KC_N   , KC_M  , KC_COMM, KC_DOT ,CTL_SLS,  KC_EQL,
                                KC_LCTL,KC_LGUI,KC_LALT ,       KC_SPC , KC_UP , KC_DOWN,
                                KC_LEFT,  LT(1,KC_HOME) ,       LT(2,KC_END), KC_RGHT
    ...
    [_LOWER] = LAYOUT_6x6(
        ...
        _______,_______,_______,_______,_______,_______,        _______,_______,_______,_______,_______,_______,
                                KC_LEFT,KC_RGHT,KC_SPC ,        KC_ENT , KC_UP , KC_DOWN,
                                        KC_END, _______,        _______, KC_PGDN
    ),
    [_RAISE] = LAYOUT_6x6(
